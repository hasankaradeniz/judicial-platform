def judicial_decisions(request):
    ...
    if has_any_filter:
        ...
        with connection.cursor() as cursor:
            ...
            if query and not (court_type or chamber or decision_number or case_number or date_from or date_to or date_range):
                ...
                # ADVANCED FILTERS WITH/WITHOUT TEXT SEARCH
                where_conditions = []
                params = []
                ...
                # Select query with ranking if text search exists
                if query:
                    search_sql = f"""
                        SELECT id, karar_turu, karar_veren_mahkeme, esas_numarasi, 
                               karar_numarasi, karar_tarihi, karar_ozeti,
